...
const Education = () => {
        return (
                <div name="𝙴𝚍𝚞𝚌𝚊𝚝𝚒𝚘𝚗" className='pb-28 pt-4 md:pt-0 w-full h-full bg-gradient-to-b from-black to-gray-800 text-white'>
                        <div className='max-w-screen-lg p-4 mx-auto flex flex-col '>
                                ...
                                <div className='mt-20 md:ml-60'>
                                        <div className='flex flex-col md:flex-row  items-center'>
                                                ...
                                                <div className='ml-20 md:ml-4'>
                                                        <p>Jaipur Engineering College and Research Centre, foundation - Jaipur.</p>
                                ...
                                <div className='mt-12 md:ml-60'>
                                        <div className='flex flex-col md:flex-row  items-center'>
                                                ...
                                                <div className='ml-4'>
                                                        <p>Tagore Vidhya Bhawan, shastri nagar - Jaipur.</p>
                                                        <p>Class - 12 (PCM)</p>
                                ...
                                <div className='mt-12 md:ml-60'>
                                        <div className='flex flex-col md:flex-row  items-center'>
                                                ...
                                                <div className='ml-4'>
                                                        <p>Sr. Sec. Adarsh Vidhya Mandir, banipark - Jaipur.</p>
                                                        <p>Class - 10</p>
